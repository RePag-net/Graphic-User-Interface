========================================================================
    DYNAMIC LINK LIBRARY: Tabelle-Projektübersicht
========================================================================

Diese Tabelle-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Tabelle-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Tabelle.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
