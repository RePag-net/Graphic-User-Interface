========================================================================
    DYNAMIC LINK LIBRARY: Bild-Projektübersicht
========================================================================

Diese Bild-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Bild-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Bild.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
